...
sumOrigami=int(input("Сколько в общем оригами было сделано: "))
def origami_for_every_child(n):
    sergey = int(n/6)
    petr = sergey
    katrin = (sergey+petr)*2
    return (sergey, petr, katrin)

print (origami_for_every_child(sumOrigami))
